...
## Function
This program performs mathematical operations on polynomials, such as addition, subtraction, multiplication, and evaluation. It allows users to input polynomial expressions and computes results with proper handling of coefficients, degrees, and like terms.
